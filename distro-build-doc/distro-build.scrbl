...
@itemlist[
 ...
 @item{@racket[#:fake-installers? _boolean] --- if true, instead of
  ...
  @item{@racket[#:site-window-title _string] --- window title for the main page
    generated by the @tt{site} or @tt{snapshot-site} makefile target;
    the default is to use the @racket[#:site-title] string

    @history[#:added "1.23"]}

  @item{@racket[#:site-logo _hash-or-false] --- a description of the
    logo to use on the main page generated by the @tt{site} or
    @tt{snapshot-site} makefile target, where @racket[#f] uses the
    Racket logo; a hash table can have @racket['src] mapped to a
  ...
  @item{@racket[#:site-icon-headers _xexpr-list-or-false] --- a
    representation of HTML elements to include within a @tt{head} tag
    to replace the default icon (in the sense of ``favicon'') for a
    page generated by the @tt{site} or @tt{snapshot-site} makefile
    target; the default is @racket[#f], which uses a default Racket
    icon list
